    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-black">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-slate-400 text-sm font-medium animate-pulse">Loading Store Environment...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-black">
        <div className="flex flex-col items-center gap-4 text-center max-w-sm px-4">
          ...
          <p className="text-slate-400 text-sm">You must be logged in as a Vendor to access this page. Redirecting...</p>
        </div>
      </div>
    );
  }
