...
import { collection, getDocs, doc, getDoc, setDoc, addDoc, query, where, orderBy, increment, deleteDoc, updateDoc } from 'firebase/firestore';
...
export async function createOrder(orderData) {
  try {
    ...
    // Dynamically reduce stock for each item
